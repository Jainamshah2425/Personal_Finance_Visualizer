...
<div className="space-y-4">
  ...
  <div className="space-y-2">
    ...
    {budgets.map((b) => (
      ...
      >
        <div>
          <p className="font-medium">{b.category} - {b.month}</p>
          <p className="text-muted-foreground">₹{b.amount}</p>
        </div>
       <div className="flex gap-2">
  <Button size="sm" variant="outline" onClick={() => setEditingBudget(b)}>
    Edit
  </Button>
  <Button size="sm" variant="destructive" onClick={() => deleteBudget(b._id)}>
    Delete
  </Button>
</div>
      </div>
